...
from app.models import Admin, Auth, Buy, Sell, Tran, test_init
...
def query():
    ...
    buy = Buy.query.filter_by ( stock_name=stock_name )
    sell = Sell.query.filter_by ( stock_name=stock_name )
    flash ( request.args.to_dict (), 'success' )
    return render_template ( "query.html", buy=buy, sell=sell )
